...
user_router.post("/register", register_middleware, user_registartion);
user_router.post("/google_login", user_google_login);
user_router.post("/facebook_login", user_facebook_login);
user_router.put(
  "/forgot_password",
  forgot_password_validator,
  run_validation,
